#Config settings for the game mechanics.
...
levelappendupd = 0 # Default 0
collisiondistance = 32 # Default 32
scoreperehit = 100 # Default 100
debug = False # Default False
hp = 12 # Default 12
baselineformula = 1.5 # Default 1.5, formula for the next level requirement.